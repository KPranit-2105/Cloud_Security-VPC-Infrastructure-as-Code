# Project 2: VPC Infrastructure-as-Code & Network Security Controls
...
**Framework/Regulation:** PCI-DSS v4.0 Requirement 1.2/1.3, CIS AWS Benchmark 5.x, NIST SP 800-53 AC-4  
**Project Type:** Fictional Portfolio Case Study  

> **Scenario Context:** Apex Cloud Financial Systems (ApexPay) – Network Segmentation Governance  

## Project Deliverables Index
- 🏗️ **VPC Architecture Terraform Code:** [`terraform/main.tf`](./terraform/main.tf)
- 📋 **Network Micro-segmentation Standard:** [`docs/network_security_policy.md`](./docs/network_security_policy.md)
